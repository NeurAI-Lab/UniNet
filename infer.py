...
from utilities.viz_utils import to_depth_color_map, draw_instances, \
...
def batched_inst_infer(args, device, tasks, model, dl_test):
    ...
    with torch.no_grad():
        for idx, (image, original_image, image_name) in tqdm(
            ...
            instances, _ = run_inference(predictions, cfg, tasks)
            ...
            if instances is not None:
                ...
                original_image = draw_instances(
                    instances, original_image, cfg, txt_size=0.5)
